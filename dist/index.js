...
var createVisibilitySystem = function () {
    // Create context
    var VisibilityContext = React.createContext(undefined);
    ...
    var VisibilityProvider = function (_a) {
        ...
        var toggleVisibility = React.useCallback(function (name) {
    ...
    var useVisibility = function () {
        var context = React.useContext(VisibilityContext);
    ...
    var createVisibilityBlock = function (name, defaultVisible) {
        ...
        var NamedBlock = React.memo(function (_a) {
        ...
        var NamedBlockToggle = React.memo(function (_a) {
            ...
            var useToggleState = function () {
                ...
                var toggle = React.useCallback(function () { return toggleVisibility(name); }, [toggleVisibility]);
...
exports.createVisibility = createVisibilitySystem;
exports.createVisibilityBlock = createVisibilityBlock;
